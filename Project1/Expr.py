...
class Expr:
	...
	def execute(self, executor):
		...
		#if func body present, then replaces existing heap values for the actual parameters with their new values that they get set to within the function
		if globals.isFunc == True:
			for item in executor.heapSpace:
				# gets index of each heap value
