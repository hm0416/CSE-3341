...
Known Bugs: For some unknown reason, if you make a blank file and just put an EQUAL sign "=" or multiple without any other strings at all,
the program halts and doesn't do anything. But if you put equal signs with a space or any other chars, it works normally. I'm not sure if this
is something that will get tested, but the EQUAL signs work just fine otherwise.